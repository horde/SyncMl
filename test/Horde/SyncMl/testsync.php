...
if (!empty($testsetuponly)) {
    $testbackend = Horde_SyncMl_Backend::factory($syncml_backend_driver,
...
function getResponse($data)
{
    ...
    $GLOBALS['backend'] = Horde_SyncMl_Backend::factory(
...
function test($name)
{
    ...
    $GLOBALS['testbackend'] = Horde_SyncMl_Backend::factory(
        $GLOBALS['syncml_backend_driver'],
        $GLOBALS['syncml_backend_parms']);
